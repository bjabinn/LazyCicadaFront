...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  {position: 3, name: 'Ezequiel Pozo Fernandez', weight: 6.941, symbol: 'Li'},
  {position: 4, name: 'Ismael Milan Márquez', weight: 9.0122, symbol: 'Be'},
  {position: 5, name: 'Jose Carlos Gadea Doncel', weight: 10.811, symbol: 'B'},
  {position: 6, name: 'Miguel Sanchez Infante', weight: 12.0107, symbol: 'C'},
  {position: 7, name: 'Alfonso García Bellod', weight: 14.0067, symbol: 'N'},
  {position: 8, name: 'David Mateos', weight: 15.9994, symbol: 'O'},
  {position: 9, name: 'David Panal Cabrera', weight: 18.9984, symbol: 'F'},
  {position: 10, name: 'Emilio Jose Palma Barroso', weight: 20.1797, symbol: 'Ne'},
  {position: 11, name: 'Jorge Carlos Lozano Gomez', weight: 20.1797, symbol: 'Ne'},
  {position: 12, name: 'Jose Antonio Beltrán Márquez', weight: 20.1797, symbol: 'Ne'},
  {position: 13, name: 'Verónica Padua Castilleja', weight: 20.1797, symbol: 'Ne'},
];
